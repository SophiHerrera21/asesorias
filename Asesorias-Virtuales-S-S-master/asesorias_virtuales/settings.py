"""
Django settings for asesorias_virtuales project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'asesorias_virtuales', 'templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'asesorias_virtuales.wsgi.application'
...
DEFAULT_FROM_EMAIL = 'S&S Asesorías Virtuales <codenova856@gmail.com>'
...
EMAIL_TEMPLATE_DIR = os.path.join(BASE_DIR, 'asesorias_virtuales', 'templates', 'emails')
...
ADMIN_EMAIL = 'ssasesoras430@gmail.com'
